...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "A trading game", // 30 characters, no emojis or special characters, short description under app name
      description: "A trading game", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
